...
describe('message transporter', () =>
  it('server client communication', () => {
    ...
    textServer.observe(() => console.debug('textServer', new Date(), textServer.toString()))
    textClient1.observe(() => console.debug('textClient1', new Date(), textClient1.toString()))
    textClient2.observe(() => console.debug('textClient2', new Date(), textClient2.toString()))

    const transporterServerTo1 = new InMemoryMessageTransporter('s>1', docServer, dummyAwareness)
    const transporterServerTo2 = new InMemoryMessageTransporter('s>2', docServer, dummyAwareness)
    const transporterClient1 = new InMemoryMessageTransporter('1>s', docClient1, dummyAwareness)
    const transporterClient2 = new InMemoryMessageTransporter('2>s', docClient2, dummyAwareness)

    transporterServerTo1.on(MessageType.DOCUMENT_UPDATE, () =>
      console.debug('Received DOCUMENT_UPDATE from client 1 to server')
    )
    transporterServerTo2.on(MessageType.DOCUMENT_UPDATE, () =>
      console.debug('Received DOCUMENT_UPDATE from client 2 to server')
    )
    transporterClient1.on(MessageType.DOCUMENT_UPDATE, () =>
      console.debug('Received DOCUMENT_UPDATE from server to client 1')
    )
    transporterClient2.on(MessageType.DOCUMENT_UPDATE, () =>
      console.debug('Received DOCUMENT_UPDATE from server to client 2')
    )

    transporterServerTo1.on(MessageType.COMPLETE_DOCUMENT_STATE_ANSWER, () =>
      console.debug('Received COMPLETE_DOCUMENT_STATE_ANSWER from client 1 to server')
    )
    transporterServerTo2.on(MessageType.COMPLETE_DOCUMENT_STATE_ANSWER, () =>
      console.debug('Received COMPLETE_DOCUMENT_STATE_ANSWER from client 2 to server')
    )
    transporterClient1.on(MessageType.COMPLETE_DOCUMENT_STATE_ANSWER, () =>
      console.debug('Received COMPLETE_DOCUMENT_STATE_ANSWER from server to client 1')
    )
    transporterClient2.on(MessageType.COMPLETE_DOCUMENT_STATE_ANSWER, () =>
      console.debug('Received COMPLETE_DOCUMENT_STATE_ANSWER from server to client 2')
    )

    transporterServerTo1.on(MessageType.COMPLETE_DOCUMENT_STATE_REQUEST, () =>
      console.debug('Received COMPLETE_DOCUMENT_STATE_REQUEST from client 1 to server')
    )
    transporterServerTo2.on(MessageType.COMPLETE_DOCUMENT_STATE_REQUEST, () =>
      console.debug('Received COMPLETE_DOCUMENT_STATE_REQUEST from client 2 to server')
    )
    transporterClient1.on(MessageType.COMPLETE_DOCUMENT_STATE_REQUEST, () =>
      console.debug('Received COMPLETE_DOCUMENT_STATE_REQUEST from server to client 1')
    )
    transporterClient2.on(MessageType.COMPLETE_DOCUMENT_STATE_REQUEST, () =>
      console.debug('Received COMPLETE_DOCUMENT_STATE_REQUEST from server to client 2')
    )
